...
export const translations = {
  en: {
      ...
      pillars: [
        {
          ...
          description:
            "We look beyond credentials. Our matching surfaces candidates who don't just fill a role — they bring something to it. Capabilities, character, and how they want to grow.",
          features: ['Skills-first profiles', 'Behavioral fit signals', 'Long-term trajectory'],
        },
        {
          letter: 'P',
          label: 'Philosophy',
          ...
          description:
            "We actually measure it. Our culture-matching engine maps how a candidate's values and working style align with your team — so you're not just guessing.",
          features: ['Values-based matching', 'Team culture profiling', 'Compatibility scoring'],
          featured: true,
        },
        {
          letter: 'P',
          ...
          description:
            'We help you look past the interview performance to find what someone is genuinely excited about — because that energy is exactly what great teams run on.',
          features: ['Engagement signals', 'Growth pathway mapping', 'Retention indicators'],
        },
      ],
    },
    tech: {
      ...
      features: [
        {
          ...
          description:
            'We look at 140+ signals across skills, values, working style, and growth potential — and show you why each match scores the way it does.',
        },
        {
          title: 'Live Culture Profiles',
          description:
            'Your team culture map updates continuously based on real behavioral signals, not annual surveys. It reflects who your team actually is.',
        },
        {
          title: 'Retention Risk Alerts',
          description:
            'Spot potential flight risk 60–90 days early. Not to surveil people — but to give managers a chance to have a real conversation before it\'s too late.',
        },
        {
          title: 'Works with your tools',
          description:
            'Connects with Workday, BambooHR, SAP SuccessFactors, and 30+ HRIS platforms. Your team keeps working the way they already do.',
        },
      ],
      stats: [
        { value: '140+', label: 'Match Signals' },
        { value: '92%', label: 'Placement Accuracy' },
        { value: '2.1×', label: 'Faster to Hire' },
      ],
      cta: 'Request a Demo',
    },
    trust: {
      ...
      stats: [
        { value: '1,200+', label: 'Organizations', sub: 'across 18 industries' },
        { value: '94%', label: 'Retention at 1 Year', sub: 'vs. 67% industry avg.' },
        { value: '48K+', label: 'Placements Made', sub: 'since 2019' },
        { value: '4.9 / 5', label: 'Client Rating', sub: 'based on 3,400 reviews' },
      ],
      testimonials: [
        {
          quote:
            "PxNexus changed how we think about hiring. We stopped looking for the perfect CV and started looking for the right person. Big difference.",
          author: 'Mia Hartmann',
          role: 'Chief People Officer, Brightloop',
        },
        {
          quote:
            "The culture-fit tool surfaced a candidate we almost skipped. That person is now our highest-performing team lead, 18 months in.",
          author: 'David Sato',
    ...
    footer: {
      ...
      categories: {
        Platform: ['Talent Matching', 'Culture Profiling', 'Analytics', 'Integrations'],
        Company: ['About Us', 'Our Story', 'Careers', 'Press'],
        Resources: ['Blog', 'Case Studies', 'HR Guides', 'Docs'],
  ...
  ja: {
      ...
      pillars: [
        {
          ...
          description:
            '経歴書だけで判断しません。能力・人柄・成長意欲を総合的に評価し、単に役割を埋めるだけでなく、チームに貢献できる人材を見つけます。',
          features: ['スキル重視のプロフィール', '行動特性の分析', '長期的な成長予測'],
        },
        {
          letter: 'P',
          label: 'Philosophy（理念）',
          ...
          description:
            '価値観やワークスタイルが、チームと実際にどれだけ合っているかを測定します。「なんとなく合いそう」ではなく、データで示します。',
          features: ['価値観ベースのマッチング', 'チームカルチャーのプロファイリング', '相性スコアの算出'],
          featured: true,
        },
        {
          letter: 'P',
          ...
          description:
            '面接での演技ではなく、本当に何に夢中になれるかを見つけます。そのエネルギーこそが、良いチームを動かす源泉だからです。',
          features: ['エンゲージメント指標', 'キャリアパスのマッピング', '定着率シグナル'],
        },
      ],
    },
    tech: {
      ...
      stats: [
        { value: '140+', label: 'マッチングシグナル' },
        { value: '92%', label: 'マッチング精度' },
        { value: '2.1×', label: '採用スピード向上' },
      ],
      cta: 'デモを申し込む',
    },
    trust: {
      ...
      stats: [
        { value: '1,200+', label: '導入企業数', sub: '18業界にわたる' },
        { value: '94%', label: '入社1年後の定着率', sub: '業界平均67%比' },
        { value: '48,000+', label: '採用成功数', sub: '2019年の創業以来' },
        { value: '4.9 / 5', label: 'クライアント評価', sub: '3,400件のレビュー' },
      ],
      testimonials: [
        {
    ...
    footer: {
      ...
      categories: {
        Platform: ['人材マッチング', 'カルチャー診断', 'アナリティクス', '連携ツール'],
        Company: ['会社情報', '私たちのストーリー', '採用情報', 'プレス'],
        Resources: ['ブログ', '事例紹介', 'HRガイド', 'ドキュメント'],
